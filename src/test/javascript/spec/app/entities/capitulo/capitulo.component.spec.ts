...
import { CapituloComponent } from 'app/entities/capitulo/capitulo.component';
...
describe('Component Tests', () => {
  describe('Capitulo Management Component', () => {
    let comp: CapituloComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CapituloComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.capitulos && comp.capitulos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
